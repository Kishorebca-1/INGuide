...
const boardMessages = {
  ...
  gratitude: "Name one small thing from today that felt warm, kind, funny or beautiful.",
...
(function initRopes() {
  ...
  function updateRopes(timestamp) {
    ...
    ropeEls.forEach(r => {
      ...
      const boardCenterX = ((boardRect.left + boardRect.width / 2) - canvasRect.left) / canvasRect.width * 100;
      const boardTopY = ((boardRect.top) - canvasRect.top) / canvasRect.height * 100;
